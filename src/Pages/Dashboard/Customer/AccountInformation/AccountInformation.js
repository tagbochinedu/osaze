  ...
  return (
    <Card className="" pageTitle="Account Information">
      <div className="px-6 py-4">
        <div className="rounded-sm max-h-40 mb-16">
          ...
          <div className="py-2 px-6  text-center">
            {DUMMY_DATA.map((data) => {
              return (
                <div className="py-5" key={data.signupData.id}>
                  ...
                  <div className="py-5 flex items-center justify-center">
                    <div>
                      <p className="text-lg font-semibold">
                        {address.signupData.houseAddress}
                        {", "}
                        {address.signupData.city}
                        {", "}
                        {address.signupData.state}
                        {", "}
                        {address.signupData.country}
                      </p>
                      <p className="text-lg mt-3">
                        {address.signupData.phoneNumber}
                      </p>
                    </div>
                  </div>
                );
