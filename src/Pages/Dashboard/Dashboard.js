...
const Dashboard = () => {
  ...
  return (
    <div className="relative flex justify-between font-merri md:px-3 md:py-1 lg:px-6 lg:py-4">
      <div className=" max-h-fit w-full md:border lg:border-2 border-gray-200 md:shadow-md shadow-gray-200 lg:rounded-lg md:w-3/12 lg:w-2/12 bg-header text-white">
